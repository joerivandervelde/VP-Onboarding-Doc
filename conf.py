...
project = 'ERDERA Virtual Platform Onboarding Document'
copyright = '2025, ERDERA'
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'env', 'venv', 'README.md']
...
html_logo ='_static/erdera-logo-small.png'
